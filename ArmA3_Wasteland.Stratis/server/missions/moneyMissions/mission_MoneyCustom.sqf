...
_setupVars =
{
	...
	[
		// Custom Hard
		[
			"Special Money Shipment", // Marker text
			150000, // Money
			[
				[ // NATO convoy
...
_setupObjects =
{
	...
	_createVehicle =
	{
		...
		_soldier = [_aiGroup, _position] call createCustomSoldier;
	...
	_missionHintText = format ["A convoy transporting <t color='%1'>%2</t> escorted by a <t color='%1'>%3</t> is carrying soldiers with Prototype Weapons.<br/>Stop them!", moneyMissionColor2, _moneyText, _vehicleName];
...
_successExec =
{
	...
	_successHintMessage = "The Special Money Shipment has been stopped, claim the money and the prototype weapons";
};
